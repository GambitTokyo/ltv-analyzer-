...
with st.sidebar:
    ...
    sample = pd.DataFrame({
        'customer_id': [f'C{i:04d}' for i in range(1, 31)],
        'start_date':  ['2023-10-01'] * 30,
        'end_date': [
            '2024-03-15','2024-05-20','','2024-01-10','',
            '2024-08-01','','2024-02-28','2024-06-15','',
            '2024-04-01','2024-07-20','','2024-09-05','',
            '2024-03-01','','2024-11-15','2024-12-01','',
            '2024-02-10','','2024-07-01','2024-04-20','',
            '2024-05-05','2024-10-10','','2024-08-25','',
        ],
        'revenue': [300,300,500,300,500,500,500,300,300,500,
                    300,500,300,500,300,300,500,300,300,500,
                    300,500,500,300,500,300,300,500,500,300],
    })
    st.download_button(
        "サンプルCSVをダウンロード",
    ...
    st.markdown("---")
    st.markdown("### ⚙️ 設定")
    revenue_unit = st.selectbox("売上の単位", ['日次', '月次', '年次'], index=1)
...
ltv_val, surv_int = ltv_inf(k, lam, arpu_daily)
...
・平均日次ARPU: ¥{arpu_daily:,.2f}
・LTV∞（無限ホライズン）: ¥{ltv_val:,.0f}
