...
_DICT = {
    ...
    'main_step1_title':         {'ja': 'STEP 01 — CSV', 'en': 'STEP 01 — Drop your CSV'},
    'main_step1_desc':          {'ja': '顧客 ID・日付・売上だけで OK', 'en': 'Just customer IDs, dates, and revenue'},
    'main_step2_title':         {'ja': 'STEP 02 — 分析', 'en': 'STEP 02 — Rigorous analysis'},
    'main_step2_desc':          {'ja': '統計手法を自動で実行', 'en': 'Statistical methods run automatically'},
    'main_step3_title':         {'ja': 'STEP 03 — アウトプット', 'en': 'STEP 03 — Results'},
    'main_step3_desc':          {'ja': 'PowerPoint / PDF にワンクリック出力', 'en': 'Export to PowerPoint or PDF in one click'},
