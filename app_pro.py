...
<div style='padding: 16px 0 32px 0; border-bottom: 1px solid #1a2a3a; margin-bottom: 28px;'>
  ...
  <div style='font-size: 0.78rem; color: #3a5a6a; margin-top: 8px; letter-spacing: 0.02em;'>Kaplan–Meier × Weibull — Segment-level LTV Intelligence &nbsp;·&nbsp; v240</div>
</div>
""", unsafe_allow_html=True)
...
with _col_ltv:
    ...
    fig_ltv.update_layout(
        ...
        height=300, margin=dict(t=50, b=50, l=70, r=120),
                ...
                with st.expander(
                    ...
                    try:
                        ...
                        fig_hor_s.update_layout(
                            paper_bgcolor='#111820', plot_bgcolor='#111820',
                            height=280, margin=dict(t=10, b=50, l=70, r=120),
                            font=dict(color='#ccc', size=10),
                            legend=dict(orientation='h', y=1.08, x=0, font=dict(size=10), bgcolor='rgba(0,0,0,0)'),
