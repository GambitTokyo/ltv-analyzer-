...
<div style='padding: 16px 0 32px 0; border-bottom: 1px solid #1a2a3a; margin-bottom: 28px;'>
  ...
  <div style='font-size: 0.78rem; color: #3a5a6a; margin-top: 8px; letter-spacing: 0.02em;'>Kaplan–Meier × Weibull — Segment-level LTV Intelligence &nbsp;·&nbsp; v175</div>
</div>
""", unsafe_allow_html=True)
...
st.markdown("<div class='section-title' style='margin-bottom:4px;'>暫定 LTV — 観測期間別</div>", unsafe_allow_html=True)
